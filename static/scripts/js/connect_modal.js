  ...
  overlay.innerHTML = `
    <div class="cm-modal" role="dialog" aria-modal="true">
      ...
      <div class="cm-actions">
        <a href="${DEFAULT_STEAM_URL}" class="cm-btn cm-btn--steam" id="cm-steam-btn">${STEAM_SVG}&nbsp;Open in Steam</a>
...
function openConnectModal(config = {}) {
  ...
  document.getElementById("cm-steam-btn").href = config.steamUrl || DEFAULT_STEAM_URL;
  document.getElementById("cm-hint").textContent = "";
  document.getElementById("cm-copy-btn").textContent = "📎 Copy console command";
